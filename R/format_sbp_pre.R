...
format_sbp_pre <- function(df) {
  ...
  tmp <- df %>%
    ...
    mutate(
      ...
      sbp_pre_mad_60 = as.numeric(sbp_pre_mad_60),
      ...
      sbp_pre_mad_120 = as.numeric(sbp_pre_mad_120)
